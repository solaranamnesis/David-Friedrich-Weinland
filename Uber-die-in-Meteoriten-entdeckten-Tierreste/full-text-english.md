...
The forms depicted in the above work are purely mechanical, that is, made without the assistance of a draftsman — and probably every zoologist and paleontologist will obtain this impression upon examining them: that in large part, if one observes them objectively, i.e. without considering their origin, then one involuntarily thinks of organic structures — because as little as one would like to be inclined to such a presumption at first, and, perhaps due to the highly enthusiastic language and bold conclusions in the text regarding these figures, it seems to demand caution.
