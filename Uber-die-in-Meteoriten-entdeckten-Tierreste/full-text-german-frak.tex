...
\begin{titlepage} % Suppresses headers and footers on the title page
	...
	{\Large Dr. David Friedrich Weinland} % Subtitle or further description
	
	\vspace*{1\baselineskip} % Whitespace under the subtitle
	
    {\normalsize In Kommission bei G. Fr"ohner, mit zwei Holzschnitten\\ Esslingen am Neckar 1882} % Subtitle or further description
...
\clearpage
\section{\frakfamily{Gittertierchen, Polycystina}}
...
\clearpage
\section{\frakfamily{Schw"amme und Foraminiferen}}
...
\caption{\frakfamily{80-mal vergr"ossert}}
\end{figure}
\paragraph{}
...
\subsection{\frakfamily{Weitere Formen}}
\paragraph{}
...
\caption{\emph{Hahnia meteoritica}, N., \frakfamily{an einem \emph{Pectiscus} sitzend. 80-mal vergr"ossert.}}
\end{figure}
\paragraph{}
...
\clearpage
\section{\frakfamily{Schlussfolgerung}}
\paragraph{}
