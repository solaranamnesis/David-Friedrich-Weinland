...
\begin{titlepage} % Suppresses headers and footers on the title page
    ...
    {\small In commission with G. Fröhner, with Two Woodcuts\\ Esslingen am Neckar 1882} % Subtitle or further description
...
\paragraph{}
($\gamma\omega\nu\iota\alpha$ = ``cornered'', $\beta\rho$o$\chi\sigma$ = ``mesh'')%(γωνια = ``cornered'', βρὁχος = ``mesh''.)
